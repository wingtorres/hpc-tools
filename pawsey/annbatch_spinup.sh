...
sed -i "s#COMPUTE NONSTATIONARY 20000101.000000 600 SEC.*#COMPUTE NONSTATIONARY 20000101.000000 600 SEC 20000114.120000#" ${annproj}/swan_ann.in #change to 30 day run

dt=1 #time step
nt=1166400 #total time of simulation in seconds
