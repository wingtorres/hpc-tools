...
for line in fileinput.input('mns.swn',inplace=1):
...
shutil.copy2('mns.swn',dirname) #put input file into folder
for files in source:
...
fdata = scipy.io.loadmat('Projects/mns/moorea_north_shore_Jan2007_field_data_for_swan')
...
#Generate timestamps 
swantime =  date_range(start='1/25/2007 19:00:00', end = '1/28/2007 19:00:00', freq='H') #model time stamp
...
for jt in range(0,njt):
    for it in range(0,len(d)):
        ...
        x = date_range(start='1/25/2007 20:00:00', end = '1/28/2007 18:00:00', freq='H')
